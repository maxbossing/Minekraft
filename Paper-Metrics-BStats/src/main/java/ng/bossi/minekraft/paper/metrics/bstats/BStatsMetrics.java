package ng.bossi.minekraft.paper.metrics.bstats;
...
public class BStatsMetrics extends PaperModule {
    ...
    public BStatsMetrics(int serviceId) {
        this.serviceId = serviceId;
    }

    @Override
    public void load(Minekraft entrypoint) {
    ...
    @Override
    public void start(Minekraft entrypoint) {}

    @Override
    public void stop(Minekraft entrypoint) {
